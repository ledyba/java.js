...
module Java2js.Java.META
  (module Java2js.Java.META.Types,
   module Java2js.Java.META.Parser,
   module Java2js.Java.META.Spec,
   Manifest (..),
   ManifestEntry (..))
  where
...
import Java2js.Java.META.Types
import Java2js.Java.META.Parser
import Java2js.Java.META.Spec
